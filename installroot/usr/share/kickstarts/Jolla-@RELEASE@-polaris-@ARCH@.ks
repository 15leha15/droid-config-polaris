# DisplayName: Jolla polaris/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: polaris
# DeviceVariant: polaris
# Brand: Jolla
...
repo --name=adaptation-common-polaris-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-polaris-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/polaris
